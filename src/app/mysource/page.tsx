...
// 游戏服接口配置
const GAME_API_URL = "http://192.168.50.77:30120/qb-qrlogin/api/get-player-info";
const GAME_API_TOKEN = "sk_your_secure_password_123456";
                                ...
                                {displayAssets.vehicles.map((v: any, index: number) => (
                                 ...
                                 {v.plate}
                                            ...
                                            <span className={`text-[10px] font-medium ${
                                                v.state > 80 ? "text-green-500" : v.state > 50 ? "text-yellow-500" : "text-red-500"
                                            }`}>
                                  {v.state}%
                              </span>
                                        </div>
